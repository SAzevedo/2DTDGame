...
//		y = 100;
	...
	public void getPlayerImage() {
		try {
			up1 = ImageIO.read(getClass().getResourceAsStream("/player/BoyUp.png"));
			up2 = ImageIO.read(getClass().getResourceAsStream("/player/BoyUp2.png"));
			down1 = ImageIO.read(getClass().getResourceAsStream("/player/BoyDown.png"));
			down2 = ImageIO.read(getClass().getResourceAsStream("/player/BoyDown2.png"));
			left1 = ImageIO.read(getClass().getResourceAsStream("/player/BoyLeft.png"));
			left2 = ImageIO.read(getClass().getResourceAsStream("/player/BoyLeft2.png"));
			right1 = ImageIO.read(getClass().getResourceAsStream("/player/BoyRight.png"));
